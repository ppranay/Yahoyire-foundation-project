    ...
    return (
        <>
                        ...
                        <div className="col-md-8">
                            <div className="top-bar-left">
                                ...
                                <div className="text">
                                    ...
                                    <a href="tel:+91-9518790689"><p>+91-9518790689</p></a>
                                </div>
                                <div className="text">
                                    <i className="fa fa-envelope"></i>
                                    <a href="mailto:yehovayirefoundation@gmail.com"><p>yehovayirefoundation@gmail.com</p></a>
                                </div>
                            </div>
                        </div>
            ...
            <div className="navbar navbar-expand-lg bg-dark navbar-dark">
                <div className="container-fluid">
                    <Link to="/" className="navbar-brand text-small">YAHOVA Yire ngo</Link>
